...
<div class="container">
	...
	<form id="rentalForm" action="#" method="POST">
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="rentalReason" rows="4"></textarea>
			</div>
		</div>
		<hr/><br>
		<!-- 그 외 체크 사항 -->
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="rentalAgreement" disabled rows="3" style="overflow:hidden;">※	이용목적 : 강의실 사용 신청 확인 및 변경 시 연락	※
※	이용할 개인 정보 : 성명, 휴대전화번호			※
※	본 신청서는 사용목적을 완료한 이후 즉시 파기함	※</textarea>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="rentalInstructions" disabled rows="3" style="overflow:hidden;">△ 강의실 사용 3일 전에 사용신청서를 제출해 주시기 바랍니다.
...
△ 사용 후 반드시 정리정돈을 해야 합니다.</textarea>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<textarea class="form-control" id="rentalStep" disabled rows="3" style="overflow:hidden;">(신청)			학생		→	강의실 사용 신청서 작성
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				...
				<label class="form-check-label">
					<input class="form-check-input" name="chk_agree" type="checkbox"> 위 모든 사항에 동의하여 강의실 사용 신청서를 작성합니다.
				</label>
				</div>
			</div>
		</div>
...
function formCheck() {
	// 예약시간 체크박스 값
	var useRentalTime_chkbox = document.getElementsByName('chk_time');
	// 사용목적 값
	var rentalReason = document.getElementById('rentalReason').value;
	// 동의 여부
	var rentalAgree_chkbox = document.getElementsByName('chk_agree');
